# CODE BACKUP IF MESS UP WITH CLASSES

# require 'json'
# require 'date'

# # the idea is to define an object so that one may apply methods to it
# # and group method into a single class which has only one purpose
